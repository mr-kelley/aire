...
- MUST follow **spec-first development**: no implementation without a governing spec. Check for existing specs before implementation; create or propose specs when none exist. Modifying behavior requires updating the governing spec first. (See `codex/spec-spec.md`.)
...
- MUST follow **planning governance** per `codex/planning-spec.md`: work within the current sprint and milestone; consult NORTHSTAR.md for decision guidance.
...
- MUST maintain **user-facing documentation** per `codex/documentation-spec.md`. Features without docs are incomplete.
...
- Behavior that another developer (or future Codex session) would need to understand.
...
- Codex runs in a sandboxed environment. Network access is disabled by default. Roles MUST NOT assume network availability unless the user has explicitly enabled it.

# Inputs
<Canonical specs, policies, project context.>

- Specification standards: `codex/spec-spec.md`
- Decision log: `codex/decision-log-spec.md`
- Git hygiene: `codex/codex.git-hygiene.md`
- State tracker: `codex/state-tracker-spec.md`
- Session context: `codex/state-pack-spec.md`
- Planning artifacts: `codex/planning-spec.md`
- Project initialization: `codex/project-init-spec.md`
- User-facing documentation: `codex/documentation-spec.md`
