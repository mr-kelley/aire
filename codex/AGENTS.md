# Aire RoleSmith — Codex

Copy this file to your project root as `AGENTS.md` to use Codex as the RoleSmith.

## Role
Read and follow: `codex/roles/aire-smith/aire-smith.role.md`
