...
## Does Not Cover
- Spec content or structure (governed by `codex/spec-spec.md`).
- Decision log content (governed by `codex/decision-log-spec.md`).
...
## Purpose
A table of contents for all specs in the project. Helps Codex (and humans) locate specs without searching. Maintained as specs are created, moved, or deleted.
...
## Rules
- Codex MUST update `specs/INDEX.md` when creating, renaming, moving, or deleting a spec.
...
- **Audience-appropriate**: user docs are for users, not for Codex. Write for the person who will use the software, not the agent that built it.
...
- time: 2026-03-21
- summary: Adapted for Codex single-agent + human model. Replaced Claude Code references with Codex throughout. Preserved all documentation types, quality standards, spec index requirements, and completion requirements.
